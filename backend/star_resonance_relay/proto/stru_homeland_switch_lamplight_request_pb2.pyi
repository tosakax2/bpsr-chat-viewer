...
class HomelandSwitchLamplightRequest(_message.Message):
    __slots__ = ("structure_uuid", "lamplight_state", "is_outer")
    ...
    is_outer: bool
    def __init__(self, structure_uuid: _Optional[int] = ..., lamplight_state: _Optional[_Union[_enum_e_homeland_lamplight_state_pb2.EHomelandLamplightState, str]] = ..., is_outer: bool = ...) -> None: ...
